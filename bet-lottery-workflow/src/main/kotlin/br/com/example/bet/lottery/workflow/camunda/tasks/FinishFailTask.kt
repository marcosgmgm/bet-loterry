...
import br.com.example.bet.lottery.domain.commands.FinishFailBetOrder
 ...
 */
@Service
open class FinishFailTask(val commandHandler: LotteryCommandHandler): JavaDelegate {

    override fun execute(execution: DelegateExecution) {
        val betOrderId = BetOrderId(execution.getVariable(WorkflowManager.BET_ORDER_ID) as String)
        commandHandler.handle(FinishFailBetOrder(betOrderId))
    }
}